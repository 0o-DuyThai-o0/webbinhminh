...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2022 at 08:46 AM
...
(141, '', '', '', '', 7, '2022-09-28', '2022-09-29', 'logo', 1, 27, 2),
...
(147, '', '', '', '', 0, '2022-09-30', '2022-09-30', '', 1, 27, 6);
...
--
ALTER TABLE `reply_comment`
  MODIFY `id_reply` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
