                ...
                <div class="col-md-12">
                    <div class="heading-banner">
                       <div class="breadcrumb">
                          <a href="/"> Trang chủ / </a>
                         <a href="/<?php 
                              if(App\Cat::find($cat_id)){
                                 echo App\Cat::find($cat_id)->cat_alias; 
                              }
                           ?>">
                            <?php 
                              if(App\Cat::find($cat_id)){
                                 echo App\Cat::find($cat_id)->name; 
                              }
                           ?>
                         </a>
                      </div>
 ...
 <div class="product-list-grid-view-area mt-20">
        ...
        <div class="text-sm-left inline-block"> 
          ...
          <div class="tt hidden-sm hidden-xs">
            <span class="hidden-sm hidden-xs">(Tất cả <?php echo $all_product;?> sản phẩm)</span>
          </div>
        </div>    
                ...
                <div class="wr_sort col-sm-12">
                  <div class="text-sm-right">
                    <div id="sort-by" class="sorby_xxx">
                       {!! Form::open(array('method' => 'POST','id' =>'myformcat','name'=>'myformcat_cat', 'action' => array('Site\SanphamController@orderby_cat',$cat_alias_loc,$cat_id,2))) !!}
                          <select id="" class="form-control" data-default-sort="manual" name="orderby" onchange="submitform_catxx();">
                      ...
                      <script type="text/javascript">
                             function submitform_catxx()
                  {
                    document.myformcat_cat.submit();
                  }
                    </script>
                    </div>
                  </div>
              ...
              <div class="col-lg-3 col-md-3 margin-bottom-50 col-lg-pull-9 col-md-pull-9">
                ...
                <div class="widget widget-price-slider">
                    ...
                    <div class="filte_cat">
                        ...
                        <?php
                          ...
                          if(isset($min_price_new->price)){
                            if($min_price_new->price>0){
                             echo number_format($min_price_new->price,0, ',', '.')." đ";
                             
                            }else {
                                echo number_format($min_price_old->price,0, ',', '.')." đ";
                            }
                           }
                            ?>
                        -   
                         ...
                         <?php
                          ...
                          if(isset($max_price_new->price)){
                            if($max_price_new->price>0){
                                  echo number_format($max_price_new->price,0, ',', '.')." đ";
                            }else {
                               echo number_format($max_price_old->price,0, ',', '.')." đ";
                      ...
                      <input type="hidden" id="min_price_new" name="min_price" value="22">
                      <input type="hidden" id="max_price_new" name="max_price" value="33">
                    </div>
                ...
                <aside id="text-3" class="sidebar left-content">
                  <aside class="aside-item sidebar-widget_text collection-widget_text">     
                    <div class="textwidget">Bạn hãy điền khoảng giá nhỏ nhất và lớn nhất vào form để tìm khoảng giá đôi giày của bạn</div>
                  </aside>
                </aside>
              </div> 
            </div>
...
<style>
  input.btn.btn-block.btn-secondary.filter {
    background: #03A9F4;
    margin-bottom: 10px;
    color: white;
}
