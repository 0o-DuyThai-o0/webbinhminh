...
$fb = new Facebook\Facebook([
  'app_id' => '1040840225975576',
  'app_secret' => '10655bb47c8961b9fa6595f67d4fb7ae',
...
if (isset($accessToken)) {
	...
	foreach ($permissions as $key) {
		if ($key['status'] == 'declined') {
			...
			$loginUrl = $helper->getLoginUrl('http://vattuphuongtrang.com/facebook/index.php', $declined);
	...
	$loginUrl = $helper->getLoginUrl('http://vattuphuongtrang.com/facebook/index.php', $permissions);
	echo '<a href="' . $loginUrl . '">Log in with Facebook!</a>';
}