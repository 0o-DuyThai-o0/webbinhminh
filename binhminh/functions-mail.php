...
function sendMail($title, $content, $nTo, $mTo,$diachicc=''){
	$nFrom = 'Đức Dương';
	$mFrom = 'ducduong.guimail@gmail.com';	//dia chi email cua ban 
	$mPass = '123congtyducduong';		//mat khau email cua ban
	$mail             = new PHPMailer();
	$body             = $content;
	$mail->IsSMTP(); 
	$mail->CharSet 	= "utf-8";
	...
	$mail->AddReplyTo('ducduong.guimail@gmail.com', 'Công ty Đức Dương');
	if(!$mail->Send()) {
